...
export const translations: Record<"en" | "ko", Record<TranslationKey, string>> = {
    ...
    ko: {
        ...
        about_subtitle: "철학",
        about_p2: "전통적인 스페인 제작 방식을 깊이 존중하며 따르되, 더 풍부한 울림과 자연스러운 서스테인을 위해 현대적인 음향학과 구조적 연구를 유연하게 접목합니다. 제가 추구하는 것은 단순히 잘 만들어진 악기가 아닙니다. 연주자의 손에서 살아 숨 쉬며, 시간과 함께 성장해 가는 음악적 동반자입니다.",
